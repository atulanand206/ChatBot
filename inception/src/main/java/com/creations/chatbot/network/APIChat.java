...
import static com.creations.chatbot.constants.AppConstants.URL_GET_AIRSPACE;
...
public class APIChat implements IAPIChat {
    ...
    @Override
    public void getAirspaces(@NonNull final ListResponseCallback<Airspace> responseCallback) {
        mNetworkManager.makeListRequest(RequestMethod.GET, URL_GET_AIRSPACE,
                null, responseCallback, Airspace.class);
    }
}
